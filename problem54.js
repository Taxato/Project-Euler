class Hand {
	...
	get isFlush() {
		...
		for (const c of this.cards) {
			if (c.suit !== this.cards[0].suit) res = false;
		}
		return res;
	}
...
class Card {
	...
	constructor(string) {
		const val = string.charAt(0);
		this.val = val in Card.faceVals ? Card.faceVals[val] : +val;
		this.suit = Card.suits[string.charAt(1)];
	}
}

const input = `8C TS KC 9H 4S 7D 2S 5D 3S AC
